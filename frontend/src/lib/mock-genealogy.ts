...
export const MOCK_PEOPLE: PersonDetail[] = [
    ...
    },
    {
        ...
        generation: 14, chi: 1,
        isLiving: true, isPrivacyFiltered: false, isPatrilineal: true,
        families: ['F059'], parentFamilies: ['F056']
    },
    {
